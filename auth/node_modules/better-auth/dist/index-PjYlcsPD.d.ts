...
declare const init: (opts: BetterAuthOptions) => Promise<{
    ...
    db: Kysely<any> | Kysely<unknown> | null;
    rateLimit: {
        enabled: boolean;
        window: number;
        max: number;
...
type InferAdditional<Options extends BetterAuthOptions, Key extends string> = Options["plugins"] extends Array<infer T> ? T extends {
    schema: {
        [key in Key]: {
            fields: infer Field;
        };
...
interface BetterAuthOptions {
     ...
     */
    database: PostgresPool | MysqlPool | BetterSqlite3Database | Dialect | Adapter;
    /**
...
declare const listSessions: <Option extends BetterAuthOptions>() => {
    ...
    } ? Field extends Record<infer Key extends string | number | symbol, FieldAttribute> ? { [key in Key as Field[key]["required"] extends false ? never : Field[key]["defaultValue"] extends string | number | boolean | Function | Date ? key : never]: InferFieldOutput<Field[key]>; } & { [key_1 in Key as Field[key_1]["returned"] extends false ? never : key_1]?: InferFieldOutput<Field[key_1]> | undefined; } : {} : {} : {} : Option extends Auth ? Option["options"]["plugins"] extends (infer T)[] ? T extends {
        schema: {
            session: {
                fields: infer Field;
            };
...
declare const deleteUser: {
    (ctx_0: better_call.Context<"/user/delete", {
        method: "POST";
        body: z.ZodObject<{
            password: z.ZodString;
        }, "strip", z.ZodTypeAny, {
    ...
    api: {
        ...
        getSession: {
            (ctx_0: Context<"/session", {
                ...
                } ? Field extends Record<infer Key extends string | number | symbol, FieldAttribute> ? { [key_2 in Key as Field[key_2]["required"] extends false ? never : Field[key_2]["defaultValue"] extends string | number | boolean | Function | Date ? key_2 : never]: InferFieldOutput<Field[key_2]>; } & { [key_3 in Key as Field[key_3]["returned"] extends false ? never : key_3]?: InferFieldOutput<Field[key_3]> | undefined; } : {} : {} : {} : Option extends Auth ? Option["options"]["plugins"] extends (infer T)[] ? T extends {
                    schema: {
                        user: {
                            fields: infer Field;
                        };
                    };
                } ? Field extends Record<infer Key extends string | number | symbol, FieldAttribute> ? { [key_2 in Key as Field[key_2]["required"] extends false ? never : Field[key_2]["defaultValue"] extends string | number | boolean | Function | Date ? key_2 : never]: InferFieldOutput<Field[key_2]>; } & { [key_3 in Key as Field[key_3]["returned"] extends false ? never : key_3]?: InferFieldOutput<Field[key_3]> | undefined; } : {} : {} : {} : {})>>;
            } | null>;
            path: "/session";
            options: {
                method: "GET";
    ...
    api: InferAPI<{
        ...
        getSession: {
            (ctx_0: better_call.Context<"/session", {
                ...
                } ? Field extends Record<infer Key extends string | number | symbol, FieldAttribute> ? { [key in Key as Field[key]["required"] extends false ? never : Field[key]["defaultValue"] extends string | number | boolean | Function | Date ? key : never]: InferFieldOutput<Field[key]>; } & { [key_1 in Key as Field[key_1]["returned"] extends false ? never : key_1]?: InferFieldOutput<Field[key_1]> | undefined; } : {} : {} : {} : O extends Auth ? O["options"]["plugins"] extends (infer T)[] ? T extends {
                    schema: {
                        session: {
                            fields: infer Field;
                        };
                ...
                } ? Field extends Record<infer Key extends string | number | symbol, FieldAttribute> ? { [key_2 in Key as Field[key_2]["required"] extends false ? never : Field[key_2]["defaultValue"] extends string | number | boolean | Function | Date ? key_2 : never]: InferFieldOutput<Field[key_2]>; } & { [key_3 in Key as Field[key_3]["returned"] extends false ? never : key_3]?: InferFieldOutput<Field[key_3]> | undefined; } : {} : {} : {} : O extends Auth ? O["options"]["plugins"] extends (infer T)[] ? T extends {
                    schema: {
                        user: {
                            fields: infer Field;
                        };
